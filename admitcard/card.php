...
if ($post_code > '99') {
	...
	$gen_ins = "<tr>
				  ...
				  <tr>
					<td align=\"left\" valign=\"top\" bgcolor=\"white\"><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"black10i\">
					 <tr>
				        <ol>
  <li> $ins_01</li>
  <li> $ins_02</li>
  <li> $ins_03</li>
  <li> $ins_04</li>  
   " . ($ins_05 ? '<li>' . $ins_05 . '</li>' : '') . ($ins_06 ? '<li>' . $ins_06 . '</li>' : '') . ($ins_07 ? '<li>' . $ins_07 . '</li>' : '') . ($ins_08 ? '<li>' . $ins_08 . '</li>' : '') . ($ins_09 ? '<li>' . $ins_09 . '</li>' : '') . ($ins_10 ? '<li>' . $ins_10 . '</li>' : '') . ($ins_11 ? '<li>' . $ins_11 . '</li>' : '') . ($ins_12 ? '<li>' . $ins_12 . '</li>' : '') . ($ins_13 ? '<li>' . $ins_13 . '</li>' : '') . ($ins_14 ? '<li>' . $ins_14 . '</li>' : '') . ($ins_15 ? '<li>' . $ins_15 . '</li>' : '') . "
			...
			<td bgcolor=\"#FFFFFF\"><table width=\"100%\" border=\"0\" cellpadding=\"3\" cellspacing=\"0\" class=\"black12\">
			  <tr>
				...
				<tr>
                 ...
                 <td width=\"60%\"height=\"10\" bgcolor=\"#FFFFFF\"> $exam_center
        ...
        <td><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"black11\">
		  <tr>
			...
			<td align=\"center\" valign=\"middle\"><img src=\"$sing_id\" width=\"120\" height=\"40\" /></td>
		     ...
		     <tr>
		     <td width=\"60%\">
			<td width=\"40%\" align=\"center\" valign=\"\" class=\"black10\">$department</td>
			</tr>
