...
<?php
	...
	if($yes == "YES" && $username != "" && $userpass != "")
	{
		...
		// Invalid Login
		if($user_count < 1){$err_msg = "Wrong User ID/Passowrd!";}
		if($card_active < 1){$err_msg = "Admit Card of $post_code $post_name is not published yet!"; $user_count = 0;}
 ...
 $file = "../images/$post_code/photo/$invoice.jpg";
    ...
    if (file_exists($file))
         { 
   echo "$app_head";
  echo "Download successful!!<br/>Please check the download folder for your admit card.";
  echo"<script language='javascript'>window.location.href=\"card.php\"; </script>";}
    else
...
<table width=\"760\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">
  ...
  <tr>
    <td align=\"left\" valign=\"top\" bgcolor=\"$body_bg\"><table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"3\">
      <tr>
		<td height=\"50\" align=\"center\" valign=\"middle\" class=\"black12bold\">Download Admit Card</td>
	  </tr>
  ...
  <!--<tr>
  <td height=\"25\" align=\"center\" valign=\"middle\" bgcolor=\"#F1DCC9\" class=\"black10\"><b style=\"color:red\"><marquee  scrolldelay=\"120\"><h3>** The recruitment examination for the post of Stenographer cum computer Operator/ Cashier/ Caretaker/ Stenotypist cum Computer Operator of Controller General of Accounts of Bangladesh will be held on 18/09/2020 at 03:00 p.m. &nbsp; ** The recruitment examination for the post of Telephone Operator/ Driver/ Photocopy Operator/ Daftary/ Sorter/ Security Guard of Controller General of Accounts of Bangladesh will be held on 25/09/2020 at 03:00 p.m.</h3></marquee></td>
  </tr>-->
