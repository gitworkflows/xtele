   ...
   <table width=\"100%\" border=\"1\" cellpadding=\"2\" cellspacing=\"1\" class=\"black10\">
	   ...
	   <tr>
          ...
          <tr>
              ...
              <td width=\"25%\" align=\"left\" valign=\"middle\">$f_day1/$f_month1/$f_year1</td>
...
if($passport_no=="") {$passport_no="N/A";}
if($nid_no=="") {$nid_no="N/A";}
if($breg_no=="") {$breg_no="N/A";}
...
$sql ="INSERT INTO cinfo ( sl , invoice , post_code ,post_name, name , father , mother, b_date, b_month, b_year, dob , age_as , sex , nid , nid_no , passport,passport_no,breg,breg_no, religion , mstatus , s_name , ffq , dept, homedistrict , 
...
screening, vcode,   d_status, org_name1, post_name1, responsible1, start_date1, end_date1, texp1, org_name2, post_name2, responsible2, start_date2, end_date2, texp2, org_name3, post_name3, responsible3, start_date3, end_date3,texp3, org_name4, post_name4, responsible4, start_date4, end_date4,texp4, org_name5, post_name5, responsible5, start_date5, end_date5,texp5, 
...
draftman, surveyor,data_entry,typ_speed,typ_spd,steno_typ, com_cer, eight_pass,dri_lic,exp_three )


VALUES ('0', '$photo', '$post_code', '$post_name','$name', '$fathername', '$mothername', '$b_day', '$b_month', '$b_year','$dob', '$ageactual', '$sex', '$nid', '$nid_no','$passport','$passport_no','$breg','$breg_no', '$religion ', '$mstatus', '$s_name', '$ff_quota','$dept','$homedistrict',
...
'$fee', '$screening', '$vcode','$ds','$organization1', '$job_post1','$job_res1','$t_day1/$t_month1/$t_year1','$f_day1/$f_month1/$f_year1', '$texp1','$organization2', '$job_post2','$job_res2','$t_day2/$t_month2/$t_year2','$f_day2/$f_month2/$f_year2', '$texp2','$organization3', 
...
'$draft_man','$sur_vey','$data_entry','$typ_speed','$typ_spd','$steno_typ','$com_cer','$eight_cert','$dri_lic','$exp_three')";
...
$out_info = mysql_query("SELECT p_value FROM 'photo_sign' WHERE 
   ...
   if($departmental == "1"){$dept_app = "(Departmental)";}
	
	
      /*$edu_out = mysql_query("SELECT * FROM `cedu`");
