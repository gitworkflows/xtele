<?php
	...
	$cpassword 	= addslashes($_POST['password']);
      ...
      include "../lib/dbconnect.php";
       ...
       $info_out = mysql_query("SELECT * FROM venue_instruction a, registration b
                                                                        WHERE a.post_code = b.post_code")or
	...
	$range_out = mysql_query("SELECT * FROM `venue_selected`
	...
	while ($rollend >= $rollstart)
	{
		$info_out = mysql_query("SELECT a.invoice AS invoice,
										...
										FROM cinfo a,  venue_selected_applicant b, post c
		...
		if($row_count> 0)
		{
			...
			<td align=\"left\" valign=\"middle\" bgcolor=\"#FFFFFF\"><span class=\"black10bold\"><B>Roll No: $rollno<br />
			  ...
			  <span class=\"black12\">
				Post: $post_name <br/>User ID: $invoice </span></td>
			<td align=\"left\" valign=\"middle\" bgcolor=\"#FFFFFF\"><img src=\"../images/$photo_id\" width=\"80\" height=\"83\" /></td>
...
<title><?php echo "$org_name | Roll: $sroll - $rollend"; ?></title>
  ...
  <tr>
    ...
    <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
      <tr>
        ...
        <td width=\"58%\" align=\"center\" valign=\"middle\" class=\"black10\"><span class=\"black11bold\"><font size='2'><b>$org_name
   <br/></font><font size='1'>Attendance Sheet</font></span><br />Post Name: $post_name<br/>
	Exam Center: $exam_center, Room No.: $room_no, Total Applicant: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Present:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     Absent: 
     <!--<td width=\"10%\" height=\"60\" align=\"center\" valign=\"middle\"><img src=\"../images/govt_logo.png\" width=\"40\" height=\"40\" /></td>-->
      </tr>
    </table>
