...
if($ds<'1') {$ds="N/A";}
if($ds=='1') {$ds="Govt. Employee";}
if($ds=='2') {$ds="Semi Govt. Employee";}
if($ds=='3') {$ds="Autonomous";}
...
if($b_month=='2')
  {
  if($b_day>'29'){echo"<script language='javascript'>window.location.href=\"edu_err.php?err=61\"; </script>";}
...
if($b_month=='4' || $b_month=='6' || $b_month=='9'|| $b_month=='11')
  {
  if($b_day>'30'){echo"<script language='javascript'>window.location.href=\"edu_err.php?err=62\"; </script>";}
...
//*****************************  Job Description Experince -01 calculation ******************************************************
 	...
 	if ($dob_month1 == "02")
	{
		$day_of_month1 = "28";
		//Check Leapyear
		if(($dob_year2 % 400 == "0") || (($dob_year2 % 4 == "0") && ($dob_year2 % 100 != "0"))){$day_of_month2 = "29";}
	}
...
// *************************************************  Jod Description Experience -03 calculation  ********************************************************
 	...
 	if ($dob_month3 == "02")
	{
		$day_of_month3 = "28";
		//Check Leapyear
		if(($dob_year3 % 400 == 0) || (($dob_year3 % 4 == 0) && ($dob_year3 % 100 != 0))){$day_of_month3 = "29";}
	}
...
// *************************************************  Jod Description Experience -04 calculation  ********************************************************
 	...
 	if ($dob_month4 == "02")
	{
		$day_of_month4 = "28";
		//Check Leapyear
		if(($dob_year4 % 400 == "0") || (($dob_year4 % 4 == "0") && ($dob_year4 % 100 != "0"))){$day_of_month4 = "29";}
	}
...
// *************************************************  Jod Description Experience -05 calculation  ********************************************************
 	...
 	if ($dob_month5 == "02")
	{
		$day_of_month5 = "28";
		//Check Leapyear
		if(($dob_year5 % 400 == 0) || (($dob_year5 % 4 == 0) && ($dob_year5 % 100 != 0))){$day_of_month5 = "29";}
	}
...
if($exp_230_02!="0")
    {
	$exp_230_02_tab = "<tr>
 		 <td height=\"20\" colspan=\"3\" align=\"left\" valign=\"middle\" bgcolor=\"$shade1_bg\" class=\"black11\"><div align=\"justify\">b. $exp_230_02: $two_expvalue_230<span 
        	</tr>";
         }
...
if($job_exp== '1')
{
   ...
   <tr>
    ...
    <tr>
              ...
              <td width=\"10%\" height=\"25\" align=\"center\" valign=\"middle\" bgcolor=\"$box1\">$f_day1/$f_month1/$f_year1</td>
...
if($validation==$code) 
    {$asq=0;}
    else {echo"<script language='javascript'>window.location.href=\"edu_err.php?err=52\"; </script>";}
...
{ $dept= "Government Employee";}
 ...
 { $dept= "N/A";}
	...
	if($b_day == "0" || $b_month == "0" || $b_year == "0" || $ffq == "0" || $religion == "0" || $present_dist == "0" || $present_ps == "0" || $permanent_dist == "0" || $permanent_ps == "0"){$data_err = "909";}
...
$loops = 3;
	...
	for($i=1;$i<=$loops;$i++)
	{
		...
		if($ex_result >= 4 && $ex_result <= 5 && $i < 3)
		{
			...
			if($ex_gpa_value >= 3){$$result_eq = 1;} // 1st div
			if($ex_gpa_value >= 2 && $ex_gpa_value < 3){$$result_eq = 2;} // 2nd div
			if($ex_gpa_value >= 1 && $ex_gpa_value < 2){$$result_eq = 3;} // 3rd div
		}
		...
		if($ex_result >= 4 && $ex_result <= 5 && $i > 2)
			...
			if($g_marks >= 60){$$result_eq = 1;} // 1st div
			if($g_marks >= 45 && $g_marks < 60){$$result_eq = 2;} // 2nd div
			if($g_marks >= 33 && $g_marks < 45){$$result_eq = 3;} // 3rd div
			if($g_marks < 33){$$result_eq = 9;} // Fail
		            }
		...
		if($ex_exam != "" && $ex_institute != "" && $ex_result != "-1" && $ex_subject != "" && $ex_year != ""){
			...
			if($ex_result == "1" && $i=="1"){$a_result = "1st Division";}
			if($ex_result == "2" && $i=="1"){$a_result = "2nd Division";}
			if($ex_result == "3" && $i=="1"){$a_result = "3rd Division";}

  			if($ex_result == "1" && $i=="2"){$a_result = "1st Division";}
			if($ex_result == "2" && $i=="2"){$a_result = "2nd Division";}
			if($ex_result == "3" && $i=="2"){$a_result = "3rd Division";}
   if($post_code=='210')
  {

  			if($ex_result == "1" && $i=="3"){$a_result = "MBBS Pass";}
}
else
{
  			if($ex_result == "1" && $i=="3"){$a_result = "1st Class";}
}

			if($ex_result == "2" && $i=="3"){$a_result = "2nd Class";}
			if($ex_result == "3" && $i=="3"){$a_result = "3rd Class";}


  			if($ex_result == "1" && $i=="4"){$a_result = "1st Class";}
			if($ex_result == "2" && $i=="4"){$a_result = "2nd Class";}
			if($ex_result == "3" && $i=="4"){$a_result = "3rd Class";}
 

  			if($ex_result == "1" && $i=="5"){$a_result = "1st Class";}
			if($ex_result == "2" && $i=="5"){$a_result = "2nd Class";}
			if($ex_result == "3" && $i=="5"){$a_result = "3rd Class";}


			if($ex_result >= 4 && $ex_result <= 5){$a_result = "GPA";}
			
			if($i == "1"){$exam_table = "exam_ssc";}
			if($i == "2"){$exam_table = "exam_hsc";}
			if($i == "3"){$exam_table = "exam_gra";}
			if($i == "4"){$exam_table = "exam_mas";}
			if($i == "5"){$exam_table = "exam_phd";}
			if($i <= 4 && $ex_exam < 9)
			{
			...
			if($exam_name != "" && $ex_year > 1900 && $ins_name != "")
			{
				...
				if($ex_result >= 1 && $ex_result <= 3 && $i=="1"){$result_type = "Division"; $result_value = "$ex_result";}

				if($ex_result >= 1 && $ex_result <= 3 && $i=="2"){$result_type = "Division"; $result_value = "$ex_result";}


				if($ex_result >= 1 && $ex_result <= 3 && $i=="3"){$result_type = "Class"; $result_value = "$ex_result";}

				if($ex_result >= 1 && $ex_result <= 3 && $i=="4"){$result_type = "Class"; $result_value = "$ex_result";}

				if($ex_result >= 1 && $ex_result <= 3 && $i=="5"){$result_type = "Class"; $result_value = "$ex_result";}



				if($ex_result > 3 ){$result_type = "GPA-$ex_result"; $result_value = "$ex_gpa_value";}
...
$_SESSION['permanent_ps']=$permanent_ps_name; 
	...
	if($present_ps == "Others"){$present_ps = addslashes($_POST['ops1']);}
	if($permanent_ps == "Others"){$permanent_ps = addslashes($_POST['ops2']);;}
	...
	switch ($nid)
	       {
		case 1: $nid_value = "$nid_no"; break;
		case 2: $nid_value = "N/A"; break;
		default: $nid_value = "";
	         }

	switch ($passport)
	   {
		case 1: $pass_value = "$passport_no"; break;
		case 2: $pass_value = "N/A"; break;
		default: $pass_value = "";
	      }

	switch ($breg)
	    {
		case 1: $breg_value = "$breg_no"; break;
		case 2: $breg_value = "N/A"; break;
		default: $breg_value = "";
	           }
	switch ($mstatus)
	      {
		case 1: $ms_value = "Married" . " - " . "Spouse Name: " . "$s_name"; break;
		case 2: $ms_value = "Single"; break;
		default: $ms_value = "";
	         }
...
echo "<form action=\"final.php\" method=\"post\" enctype=\"multipart/form-data\" name=\"app_form\" id=\"app_form\" onsubmit=\"return app_form_validator(this)\">
			...
			<input type=\"hidden\" name=\"phd\" id=\"phd\" value=\"$phd\" />
			 ...
			 <input type=\"hidden\" name=\"institute1\" id=\"institute1\" value=\"$institute2\" />                        
